...
E2E_ENV = .env.test
# SITE_DOMAIN / API_TOKEN / MD_API_TOKEN live in $(E2E_ENV) (see env_examples/env.test):
# the base compose ${VAR:?...} guards are satisfied via --env-file, so no inline exports.
